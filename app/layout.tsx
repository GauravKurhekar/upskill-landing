...
export const metadata: Metadata = {
  ...
  description: "Book your 1:1 clarity call with a Microsoft & Databricks Certified Senior Data Engineer with 10+ years of experience. Get personalized career guidance, real-world insights, and a clear roadmap to launch your data engineering career.",
